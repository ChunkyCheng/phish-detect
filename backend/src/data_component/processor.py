...
BANK_KEYWORDS = {"bank", "credit card", "debit card", "payment", "billing", "paypal"}

CRYPTO_KEYWORDS = {"bitcoin", "wallet", "crypto", "usdt", "ethereum", "seed phrase"}
...
def extract_keyword_hits(text, categories):
    ...
    for cat, keywords in categories.items():
        ...
        if hits:
            results[cat] = {"count": len(hits), "matches": hits}
...
def process_all_jsons(input_dir):
    ...
    output_dir = input_dir.parent / "safe_processed"
